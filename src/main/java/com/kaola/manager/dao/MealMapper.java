...
public interface MealMapper {
    @Insert("INSERT INTO meal (money, meal_type, meal_desc, meal_days, name) VALUES (#{meal.mealMoney},#{meal.mealType},#{meal.mealDesc},#{meal.mealDays},#{meal.mealName})")
    ...
    @Update("UPDATE meal SET name=#{meal.mealName},money=#{meal.mealMoney},meal_type=#{meal.mealType},meal_days=#{meal.mealDays},meal_desc=#{meal.mealDesc} WHERE meal_id=#{meal.mealId}")
